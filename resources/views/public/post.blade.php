...
@section('content')
    <div class="bg-white py-12 min-h-[70vh]">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <a href="{{ route('posts') }}"
                    class="text-primary-600 hover:text-primary-800 font-medium inline-flex items-center transition">
            ...
            <article>
                <header class="mb-8">
                    ...
                    <div class="flex items-center text-gray-500 text-sm">
                        ...
                        <time
                            datetime="{{ $post->created_at->format('Y-m-d') }}">{{ $post->created_at->format('d F Y') }}</time>
                ...
                <div class="mt-12 pt-8 border-t border-gray-200">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="https://twitter.com/intent/tweet?url={{ urlencode(request()->url()) }}&text={{ urlencode($post->title) }}"
                            target="_blank"
                            class="px-4 py-2 bg-primary-500 text-white rounded-md hover:bg-primary-600 transition flex items-center">
                            Twitter / X
                        </a>
