                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.galleries.update', $gallery) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required value="{{ old('title', $gallery->title) }}">
                        </div>

                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Upload Foto Baru (Opsional)</label>
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $gallery->image) }}" alt="Gallery Image" class="w-32 h-auto rounded">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" rows="3" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('description', $gallery->description) }}</textarea>
                        </div>
